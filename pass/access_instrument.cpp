...
namespace {
    ...
    Function * AccessInstrumentationPass::loadExternalFunction(Module *m, Module *extM, const char *name) {
    ...
    string AccessInstrumentationPass::getGEPType(GetElementPtrInst *gep) {
    ...
    string AccessInstrumentationPass::getValueType(Value *v) {
        std::string t_string;
    ...
    StringRef AccessInstrumentationPass::getGEPVarName(GetElementPtrInst *gep) {
    ...
    string AccessInstrumentationPass::getVarName(Value *v) {
    ...
    void AccessInstrumentationPass::instrumentAccess(Instruction *si, char accessType) {
        int line = -1;
        int col = -1;
        int fileid = -1;
        int tid = -1;
    ...
    void AccessInstrumentationPass::instrumentAlloc(CallInst *ci) {
    ...
    void AccessInstrumentationPass::queueAndInjectArgsToLog(Function *f) {
        if (f->empty()) { return; }
    ...
    bool AccessInstrumentationPass::runOnModule(Module &m) {
